...
public class Func_CC2420_Noise extends FunctionBasic implements IRIS_FunctionModule {
	...
	public String getFunctionDescription() {
		...
		return "Converts the delivered Noise value from a CC2420 transceiver into real Noise [dBm]";
	}
