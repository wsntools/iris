...
public class Func_OneVal_Min extends FunctionBasic implements IRIS_FunctionModule {
	...
	public String getFunctionDescription() {
		...
		return "Finds the minimal element of all values";
	}
	...
	public float[] computeData(float[][] val, float[] set) {
		...
		float min = val[0].length > 0 ? val[0][0] : 0;
