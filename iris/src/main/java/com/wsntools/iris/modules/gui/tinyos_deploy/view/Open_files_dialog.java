...
public class Open_files_dialog extends JDialog {
	...
	public Open_files_dialog(AbstractController cont) {
		super();
		this.setTitle("Open..");
		this.cont = cont;
...
//		this.setModal(true);
	...
	public void setHw_file_txt(JTextField hw_file_txt) {
		this.hw_file_txt = hw_file_txt;
	}

	public void setApp_file_txt(JTextField app_file_txt) {
		this.app_file_txt = app_file_txt;
	}
}
