...
public class Func_Basic_Sub extends FunctionBasic implements IRIS_FunctionModule {
	...
	public String getFunctionDescription() {
		...
		return "Computes the difference of two values";
	}
