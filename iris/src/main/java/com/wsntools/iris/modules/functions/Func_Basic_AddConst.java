...
public class Func_Basic_AddConst extends FunctionBasic implements IRIS_FunctionModule {

	@Override
	public String getFunctionName() {
		
		return "Addition Const";
	}

	@Override
	public String getFunctionDescription() {

		return "Adds a constant to the value";
	}
